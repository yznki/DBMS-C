...
void insertPatientPhone(PatientPhones newPatientPhone)
{
...
void patientPhonesTable(PatientPhones *patientPhonesIndex[], Patient *patientIndex[])
{
    ...
    while (choice != 5)
    {
        ...
        {
        case 1:
            insertPatientPhone(newPatientPhone);
            break;
